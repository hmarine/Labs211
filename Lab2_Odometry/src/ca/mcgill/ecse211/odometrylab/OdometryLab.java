...
public class OdometryLab {
	...
	public static final double TRACK = 9.80;
	...
	public static void main(String[] args) {
		...
		//TODO take this out of the comment, must be in 
		...
		if (buttonChoice == Button.ID_LEFT) {
			...
			leftMotor.forward();
			leftMotor.flt();			//set the motor into float mode
			rightMotor.forward();
			rightMotor.flt();			//set the motor into float mode
